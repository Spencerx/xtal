...
DSP, FPGA/FPSC/ASIC, HPC, Hybrid, Optical and Stream computing, Analogue & Digital Radio, 
...
Status and Perspectives(The lockdown bottlenecks are a good context) https://www.ncbi.nlm.nih.gov/pmc/articles/PMC9267976/
...
Ethernet Roadmap and Graphic Poster available via http://www.ethernetalliance.org/
...
*cell towers aren't data centers with architects designed HVAC - cooling services with CHP power plants - they usually generate enough warmth but no cooling, this is off topic. Newer generation computing can solve such problems with better carbon neutrality and thermal footprints using more than just the grid. 
