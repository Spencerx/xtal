        ...
        is to keep the mind cool, you don't need a pandemic two decades after a fresh one to create a lock down then antivirus again, 
        all this is not new information but with the right tools a new way of working can help solve problems.
        ...
        computers when you can optical computers with existing semiconductors systems to solve rigorous problems with faster throughput 
        and purpose made language, vocabulary for higher memory footprints with lower energy or thermal problem statements.
...
High & Broadband clock speeds you can expect from Optical bandwidths currently upto 20GHz is the best known limit in 2024
...
Recommended Reading for a technical organisation/individuals only: "Managing Technical People", Topic reading:"Engineering Mathematics", "Technical Mathematics", "Technical Communication" and PSP/TSP books by Watts S Humphrey for software team and individuals among others.
...
specific to how much a place can compute at scale without being able to move tonnes of material processed or otherwise in or out, so just knowing how much waste is made against what is produced and seem in the environment is important measure, how many plastics production lines are unnaccounted for instance and when that occurred in the past. Most mad made waste can be converted in energy be it biomass, combustible material or gas not just landfill, the limit is the recycling 
...
addresses real matter in space without a reference to time, is not a motivating factor but seeing the physical world neutralising the natural hazards by understanding them and known limits of engineering which we really haven't challenged for a long time expecting comic book nations, Incas, pharaohs among many other to leap into the realm of the current because you really have to be this critical about a lack of progress in many level and acknowledge for what it is not only asa tourist but more than just a visitor, just note how all this is called past wealth all in convenient past tense anywhere in the world . 
...
Eastgate on youtube https://www.youtube.com/results?search_query=NatGeo+Eastgate+Harare
...
time to reach the world we have well known limits such as thinking one thought at a time, in keeping a open mind we struggle to see in academia 
...
dream? So it's very easy to fool our minds into conforming into a trend and nothing more rather than the needs that trend accross boundaries without regard
