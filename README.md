...
"Don't reinvent the wheel" SE101/ENG101 class and some texts in any variation, management 101 class only counts as long as one doesn't have to be too academic or without an anchor in firing academic cannon at moving targets, a stable but dynamic team does the trick effortlessly from a good courseware all the basics are really practical and hands on contained within subject matter ike a good blueprint and schematic.  
...
"Name your Topic'for Dummies such as so called AI for Dummies, Puppet(DevOps) for Dummies'", "Design For Dummies", This exists "HPC for Dummies"
Anyways
...
Sage, with applications with basic cognitive ability such as IBM Watson or Wolfram Alpha since you also have little tools such as Coq or lean among many others that are in the news trends, you have
 to ask how much you can achieve with the popular tools by practice in your daily routine without breaking the bank(PNP) and overthink, they only have the cognitive ability as a product of human 
 creativity thus interaction through creation. Architects for example don't worry themselves with peak time grid usage, over crowding symptoms you see in traffic but this is now a engineering opportunity with 
 electric or hybrid power trains especially in industrial applications for those who are already in the space earning pay from that, of course peak time usage is a different type of problem statement because talk about sustainability is over rated in due course of getting sustainable like growth hacking when you have to strike a balance(supply/demand), you see the grid simply shuts down in peak usage regardless of summer or winter time.  
...
the other way(s) around because to a person with hardware all these problems look funny not to different from landlocked borders that are surrounded by oceans of salt water that can't be used for 
bath or waste water, after all some data scientists or informatics professionals talk about controlling information like water such as personal data, it's interesting how sewers and the internet get clogged 
up with fatty big garbage input and output, so this is very funny to anyone who can grasp this concept. So anything NVIDIA or any GPU workstation manufacturer makes simply adds to the concept of the workstation jut as servers in the cloud can when you can do the math and rack up your own compute pile in a rack mount.

When you won't accept dilution from mobile domains because at least the cloud is virtually accessible anywhere to almost anything with the caveat of 'anything'! Particularly nothing for example coverage and pockets). 
After all this a game of chicken between getting something done and not at all when you look at some aspects of how people never get to work on the physical environment using machines for what
they are made for. There's also the social landscape in a any neighbourhood you know that everyone knows who everyone is not matter what, especially in retrospect g, so this should explain how 
some people always expect someone to remember every single person when you can go through a dozen cities in a year or a far more in a decade when they are not initiating communication, the same
way you can have knapsack problems in packing your backpack(people usually don't gain the ability to translate this into plain language which can be made into code to make algorithms) or laptop bag you can't really expect people to be in the same "mind space" just because you can be connected to someone via socials or use the blockchain with 'crypto' to inflate value where there is no application even the old world still expecting services to keep up with change. In reality it looks more like a nuisance when there is no human interaction but you can easily tout rural, small town to city or continental migration at aby single scale of traffic so see 
the aircraft, busses, boats, cars, trains and ships for what they are, there is no learning in pure expectation without a goal to communicate beyond the abstract representation of what a city should be
when everyone has a schedule to keep, it is easy for people keep a routine when they work, travel or learn together in exactly the same space without living anything to chance except for those 
who quickly adapted to SMS then the internet but usually it was the other way around with email at work first then text messages through ICQ IM services or what nought, some simply abandoned their landlines in being mobile so that is how you can be abstract but be creative in seeing this as missing numbers from the numbers explosion in the last mobile expansion, so it very easy to see the new model but not the people who need to be in a directory or address book, so naturally in reflection of what could have been like in a game from the console generation some expect to be able to reconnect when there is no use of name as you would in a place of learning, working with or without the direct participation because you usually pass though a filter such as a entrance gate, door, floor ten lab or office, so this dissociative problem is easily scaled up to orbit because people are not ink or pixels in a directory, when you need a connection you go direct to the provider such as geostationary or LEO, maybe Inmarsat, VSat or it's third party ground station operators usually some sort of IAP(Internet Access Provider) but you would call that a ISP by any name or brand but in SpaceX StarLink you really don't need the superstitious third party or person speak getting into the ping because a remote post office or health establishment maybe a mobile craft or vehicle is at the mercy of stitious town sheepish ship dithering(loose lips sink ships) when there is the real service to deploy like scampering rain water with no surface retention running into to the cracks then the ocean because that's what it looks like and you can factor in the human cost in human factors chalking all the way up, cluttering up the simple on off deliver test, license, deploy and use, the only party getting the right credit is a regulator as long as there is something not the nothing - this doesn't happen for human machine interfaces and computer interaction the same way it used to, so people are expected to remember timing, name and address to get a message across to the same old housemate, classmate or neighbour you may have gone to college with but when you add time zones to the mix that's a different scenario where you can't expect the same responses you used to get a few hours or weeks after leaving the lab because of time difference then, there's the spatial aspect in the mind people always expect similar robotic responses when people are multitasking ie: busy like a train schedule so don't get me started on those along with planes, satellites and ships. You see I remember growing up in a city when we had traffic patrol in the neighbourhood along with some Jamaicans, so you mix that you don't exactly get calypso or reggaetron instead I can relate to the mainline European train stations and how traffic wardens shout at train driver and lazy train boarders(it's not chacha, rhumba, tango or tap dance patterns but you get the gist), it's a rhythm thing so you don't need Apps with or without RDS or PTY notification on a MP3 player to keep you in play syncing with a train time(fast or slow train then road traffic), WYSIWYG, maybe a map will do but you fill in the rest with changes in times as per day at a time, because this is what the content looks like, can you imagine content getting shouted onto the web? 
Well I used to watch with stoically, arms folded as wondering why some kids where so flustered about how they should be in a hurry to get 'grade inflated' like hype inflated helium balloons when I was in kindergarten especially when some kids as teenagers thought it was a must to attend 'something' in their heads that looked bigger than their shoe size in the neighbourhood(*hint*). You see in many towns you can hear a train but you won't see it(unlike planes) so that has always been the funniest joke because when you are near a toy train station or a amusement park train station. So the stupidest thing a pilot could say to me saw look at the sky you will see me in the plane along this line in the sky, hence air line but hey.

In this scheme of things one has to wonder why someone expects the lights to be on when there is so much demand in that particular moment of peak time because everyone else is still grid dependent even if it means charging a car because their web of energy(debt) still requires a public utility of some sort.The blockchain allows traceability, so from this we can deduce from past work beyond a basic need of a proof of work from past data such as power usage you can estimate how much power from each transmitter was used per year provided the data is available to see how inefficient the internet is in current state or how people are still buying electrical gadgets in the middle of a blackout. You see international broadcasting is surprisingly not so big on the socials the way it was big in the eighties through to the noughties but we can come up with a good picture of human infrastructure and power investment into it never managed to exploit a social bandwagon of sorts (including influencers from that scene) of the world radio which is only slightly diminished with many other sources of content filling in that never transitioned into the web but where really pioneers of web radio and podcasts when you had this in the mid nineties or proof of concepts from so called 'IT' boffins then when it wasn't popular yet(IT included in every acronym you can imagine) because time and meaning in a dynamic world do not stay constant especially considering switches and context in which they are used.
This all uses some form of private or public utility, so one can question the crash and burn that people have invested into the upper atmosphere just outside the earth's air where you have the lowest orbiting satellites with a some still in orbit but not operating without continuity and expectation that operators or inventors had in mind from the first launches or science fiction fantasy until what is advertised along with waste don't add up in some kind of analysis by anyone who didn't need to be there to see the design and launch of service in reference to the waste in orbit. Picture this television and world music would not be the same today without satellites. Also picture how someone spends a lot of time in traffic it becomes some 'game of life' metaphor(hence the start menu GPU gaming/stream cards) when you tend to entrain the traffic routine instead of doing some real human centred activity of  getting into a groove of productivity it is more abut bundling yourself into a cost benefit structure depending on if you had to be in the (poisinous to some) ivy league or some neo classical university as in some of the oldest ones around people miss the point when you have to spend a little more time than they have to in traffic, so you now have the concept of fifteen minute city, well radio needs to be accessible in city surrounding regions because that makes the concept of human entered productivity practical rather than spending more time than you have to looking at a screen during commute it's about running through the day without worrying about which source your radio or podcast stream is coming from, be it some cloud your telephone('smartphone' or tablet) is operating in the cloud of mobile towers along with the web of energy running that web of energy bills to chucked at you, the point is moot without the coordination, most radio comes from a racked machine or device with a network address and network interface, people just didn't notice it until lately when some broadcasters still have a huge budget that's exactly efficient in getting the word out unless you bundle up and do more than a dollar a day unless subsidised by WiFi which is very funny in public transit especially on long journeys. Ofcourse if you were in nineties and you where at a content heavy organisation such as any type of content publisher, then you could put two and two together to say unlike everyone else who is talking about AI or robots taking over their jobs because they want to a live in a anime script an story board when they define the story pen or paper not included here or there were ears do more listening than they have to without the output, anyone who has had to sing because everyone else is supposed to be doing it might sing in agreement or spend hours in listening sessions just because someone is sending records. So if you could see that back then it was just a matter of saying duh, you will have a network interface in addition to your your physical media, books, movies and record are still physically delivered by courier and you still need the device to be made and delivered so making it easy rather bloated with gimmicks was the original intention for the reader, listener and watcher who is depending on some sort of utility, manufacturing is a utility.

This doesn't improve with more age or time(subject to change plus investment),  factor mean time before failure along with exposure, to and with more people(demand) when technology services are run by people supervising them(supply) as they are the more people in the mix it just gets rustic when there is more content than connections like sewer infrastructure(Internet of whatever), housing is a engineering service as designed by an architect as infrastructure as a service, so things get a bit more rustic when switches trip with cables fraying then whole urban or suburban blocks have blackouts maybe a blown transformer or two all in slow motion or time lapse with someone saying slowly but like a broken record why they don't use rust activating ocean parks instead of just dumping, in the mind supply meets supply aka B2B, take blockchain to blockchain instead for saltwater to flush or wash thinking at the same scale as hunting for a power point for a power block is not exactly the same physical proposition with power demand than can be satisfied in day without a block(not the same as carrying containers without the grid energy at the point of access, the drift is clear), that this inability is a act of structural and structured cowardice, also all this is supported by structural engineers, there is always more demand than satisfies the need, the world is getting lazier expecting technology to just show up like high B.M.I in reference to body count per building versus traffic digits and the pun you can imagine about (hyper)inflation when you have more people than was planned for, you can see in cell towers because you don't have to imagine under service when a service taps out. Age doesn't improve infrastructure or housing but people always like character or emotional property rather than intellectual property(blue prints, drawing sheets obviously) of addressing the incoming population boom while you have empty houses with ageing populations in certain places. Yes it is necessary to remind people that housing is infrastructure. So yeah it's another console paradox, like the command line and the gaming console with the expectations such as voids when you have only a touchy touch or douche screen whichever you prefer expecting your self to be reflecting the capabilities of a telephone exchange when you are only on whatsapp or facebook in the middle of a no network area or power outage probably both usually two bars at best on 4G/VoLTE sometimes HSPA/+ like 2.5G when the base tower is in a mode swing, so this is where it's necessary to deploy that damned satellite terminal especially if you just use the cloud in the middle of the desert but a portable satellite dish costs northwards of at the very least of three grand in dollars, euros or pounds but usually as much as a the latest mainstream sedan or SUV, so who cares about your exploration, you, duh. At least when you work via the cloud you can search via the search engine and not just dither around 'mobile' so called socials that always sound like they are on limited hospital type kind off bundles from whoever is claiming to be a ISP in a on demand gig economy versus the whole world, all of it, along with the animals and bugs. Sometimes all you need to be able to do is turn on a radio but a TV is now totally optional because people just don't have the time for it anymore but you could stream a few channels online and sports events along with gaming...

As a kid living with or near in  the neighbourhood mathematicians they liked the fun the only amount they would get outside the office, this includes the building owners along with their actuarial ideas, re ha ha. I poked(yes fun) at them because most kids can now relate the abstract to the reality of using computers, at least gaming computers or consoles, remembering PBS' Mathnet not the numeric package(https://www.vox.com/2015/1/21/7862165/mathnet-monday-frankly) in addition to the books with mathematics using computers in exercise examples and old school arithmetic, this was easy for me with access to the Unix command line remember as a digital(as in numbers) native in whatever generation all this is easily accessible to agile minds, this was faster than just getting the usual Atari's, Amigas, Apple Macs, IBM PCs along with the more obscure BBC Micros, Amstrads, or Spectrums maybe the TV consoles Nintendo, Sega or what have you - there is a certain simplicity that people expect(expectations) out of console gamers  unless you had to do everything we of the first generation of consoles where expected to do everything to make the console tick but usually their were sold as some sort of home video computer.
...
out of context once they become a faded memory left to mere chance or probability as stressed by Hogben on latter(time context) alone. The rest is science fiction just as science is purely
...
trial and error maybe just pure experience including spur of the moment. There is much that doesn't last in the organic material world along with stories long lost to posterity. You know what they say about junk and magic along with another man(or robot) without me leading you on into a noddy session.
...
Secondary Topics:
3D Printing, 3D P PCB(Printed PCB), AI, Additive Manufacturing, Blockchain, Data Acquisition- DaQ, Data Recording, Data Recorders(also SCADA - Supervisory Control Data Acquisition Applicaions including Programmable Logic Control with backwards compatibility for open standards such Thinnet, Serial RS232/c, Parellel RS455 RS485, Radio Links, or obscure OSI layersstill in use in infra), DevOps(for multimedia, design), EDA, Engineering Continuum, Formal Verification, Generative Coding(JVM, VHDL, Assembler, C, UML), Multi Physics, Technical Documentation & Modelling with or without Generative AI/Content,
